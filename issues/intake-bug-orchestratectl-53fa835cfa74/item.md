...
The preflight also treated three old terminal `failed` orchestratectl runs as unresolved ownership solely because their worktree paths still existed. Their substantive work had already been superseded by later landed runs. None had a live supervisor or awaited input.
...
3. stale terminal failed runs whose cleanup is an orchestratectl maintenance concern.
