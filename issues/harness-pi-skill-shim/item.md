...
- Maps `/worktree-merge`, `/complex-rebase`, "self-merge" → the plain `taskfleet run merge` bash; `/llm-review` / sub-agents → skip; any other `/name` → Claude-only, ignore.
