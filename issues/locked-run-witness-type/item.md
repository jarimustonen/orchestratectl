...
- **Miksi tämä vaatii oman suunnittelunsa**: `RunLock::with_lock` täytyy palauttaa `&LockedRun<'a>` -witness, ja jokainen lukotonta varianttia kutsuva (CLI:n `event create`, tulevat supervisor-polut) pitää muuttaa ottamaan witness vastaan. Refaktori koskettaa taskfleet-core-API:a julkisesti; vaatii harkitun julkisen tyypin nimen, lifetime-kontekstin, ja regression-testit nykyisille kutsupoluille. Liian iso muutos tämän PR:n scopeen.
