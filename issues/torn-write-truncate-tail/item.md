...
- **Milloin tämä näkyy käyttäjälle**: kun taskfleet-prosessi kaatuu kesken `events.jsonl`-rivin kirjoituksen (tappo, kernel-paniikki, levyn täyttyminen) ja seuraava sanctioned-write-path-kutsu yrittää appendata uutta tapahtumaa.
