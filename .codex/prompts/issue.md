...
This skill was installed for `issuectl 0.6.3`. On the
...
- **Older than `0.6.3`**: tell the user the skill expects
  `0.6.3` and suggest upgrading via the same channel
...
- **Newer than `0.6.3`**: the installed binary is ahead
